...
function LandingPage() {
  ...
  return (
    ...
    >
      {/* landing- main intro */}
      <div className="left w-full md:w-1/2 bg-black h-1/3 md:h-screen flex justify-center mt-28 md:mt-0">
        <div className="text-white  md:w-1/2 content-center flex flex-col justify-center pt-10">
      ...
      <div className="right right-0 w-full md:h-full md:w-1/2 bg-black md:bg-white md:h-screen flex flex-col items-center justify-center">
        <div className="about-container w-4/6 md:w-4/5 xl:w-3/5">
          ...
          <p className="about-text text-md font-inter text-white md:text-black text-lg py-2 pt-4 font-light">
